...
export function PlayerAvatar({
  ...
  // Elegant fallback: Initials badge with brand theme and subtle sport icon
...
/** Default pickleball paddle / ball silhouette SVG icon */
export function DefaultPlayerIcon({ size = "md", className = "" }: { size?: "xs" | "sm" | "md" | "lg" | "xl"; className?: string }) {
